...
export function Testimonial() {
  return (
    <section className="py-[12vh] md:pr-14">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 px-0 sm:px-8  mx-auto max-w-[80%]">
        {/* LEFT (Sticky Text) */}
        <div className="lg:sticky lg:top-[10%] self-start">
          <div className="px-4 sm:px-6 py-4 rounded">
            ...
            <p className=" font-light text-[var(--color-secondary)] text-left text-sm sm:text-base">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex justify-end">
            <div className="w-full sm:w-[80%] flex md:flex-row flex-col items-center gap-4 py-4 px-6 rounded-2xl border">
              <div className="flex justify-center items-center  h-24 w-24 rounded-full overflow-hidden ">
          ...
          <div className="flex justify-start">
            <div className="w-full sm:w-[80%] flex items-center gap-4 flex-col sm:flex-row py-4 px-6 rounded-2xl border">
              <div className=" flex justify-center items-center  h-24 w-24 rounded-full overflow-hidden ">
                <FaRegUser className=" text-4xl md:text-6xl" />
              </div>
              <div className="flex-1">
                ...
                <p className="text-sm sm:text-base font-montregular">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias
                  nesciunt maiores, laboriosam rerum voluptatem quaerat facere
                  accusantium, culpa optio quia porro.
                </p>
